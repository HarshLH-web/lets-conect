  ...
  return (
    <div className="flex flex-col items-center justify-between lg:gap-8">
      ...
      <div className="md:w-3/5 mb-8 md:mb-0 text-center">
        <h3 className="text-[#DE0402] text-xl lg:text-3xl font-semibold">
          TESTIMONIAL
        </h3>
        <h2 className="text-4xl lg:text-6xl 2xl:text-7xl font-extrabold mb-4 capitalize">
          What{" "}
          <span className="text-[#DE0402]">
            Our <br /> Clients
          </span>{" "}
          Say
        </h2>
        <p className="text-base lg:text-lg max-w-2xl text-gray-500 mx-auto font-medium">
          Some of our amazing happy hosts share their experiences and send
          smiles.
        </p>
      </div>
