...
function Header() {
  ...
  const [isMobileRegistrationOpen, setIsMobileRegistrationOpen] =
    useState(false);
    ...
    <header className="bg-white text-black lg:text-black/10 w-full lg:border-b-[1px] fixed top-0 z-50">
      <div className="max-w-[90%] lg:max-w-[95%] xl:max-w-[85%] mx-auto sm:px-4 py-2 flex items-center justify-between">
        ...
        >
          <nav className="flex flex-col items-center py-8 space-y-4">
            ...
            >
              <button
                onClick={() =>
                  setIsMobileRegistrationOpen(!isMobileRegistrationOpen)
                }
        ...
        <nav className="hidden lg:flex items-center space-x-6 ">
          <Link
            href="/"
            className={`text-base font-semibold relative group transition-all duration-300 ${pathname === "/" ? "text-[#000000]" : "text-[#7b7b7b]"}`}
          >
            <span>Home</span>
          ...
          <Link
            href="/about-talent-agency"
            className={`text-base font-semibold relative group transition-all duration-300 ${pathname === "/about-talent-agency" ? "text-[#000000]" : "text-[#7b7b7b]"}`}
          >
            <span>About</span>
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#DE0402] group-hover:w-full transition-all duration-300"></span>
          </Link>
          <Link
            href="/our-services"
            className={`text-base font-semibold relative group transition-all duration-300 ${pathname === "/our-services" ? "text-[#000000]" : "text-[#7b7b7b]"}`}
          >
            <span>Services</span>
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#DE0402] group-hover:w-full transition-all duration-300"></span>
          </Link>
          ...
          >
            <button
              ...
              className="flex items-center relative group transition-all duration-300 text-[#7b7b7b] hover:text-[#000000]"
            >
          ...
          {/* <Link
            href="/blogs"
            className={`text-base font-semibold relative group transition-all duration-300 ${pathname === "/blogs" ? "text-[#000000]" : "text-[#7b7b7b]"}`}
          >
            <span>Blogs</span>
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#DE0402] group-hover:w-full transition-all duration-300"></span>
          </Link> */}
