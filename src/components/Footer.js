    ...
    <footer className="bg-[#0B0B0B] text-white pt-10 pb-5 lg:border-b-4 border-[#DE0402] mt-32">
      <div className="w-full lg:w-[100%] max-w-[90rem] mx-auto flex flex-col lg:flex-row lg:justify-center gap-8 px-6 lg:px-0 xl:px-6">
        ...
        <div className="order-1 lg:order-3 text-center relative lg:w-[30%]">
          <div className="bg-[#DE0402] lg:p-9 xl:p-12 rounded-3xl lg:rounded-b-none lg:rounded-t-[2.5rem] -mt-24 md:-mt-20 pt-20 lg:absolute bottom-[-61px] h-[27rem] lg:right-0">
            ...
            <p className="text-4xl md:text-5xl font-bold mb-4 mt-6 lg:mt-12">
              Contact Us
            </p>
                ...
                {[
                  {
                    icon: "/fb-icon.png",
                    label: "Facebook",
                    href: "https://www.facebook.com/profile.php?id=61557976949556",
                  },
                  {
                    icon: "/insta-icon.png",
                    label: "Instagram",
                    href: "https://www.instagram.com/lhtalentagency/",
                  },
                  {
                    icon: "/li-icon.svg",
                    label: "Twitter",
                    href: "https://www.linkedin.com/company/live-hosting-agency/",
                  },
                  {
                    icon: "/yt-icon.png",
                    label: "YouTube",
                    href: "https://www.youtube.com/channel/UCMJduDDm_mOpsPQI9AD0Wlw",
                  },
                ].map(({ icon, label, href }) => (
                  <a
                    key={label}
        ...
        <div className="order-2 lg:order-1 lg:pb-12 whitespace-nowrap lg:w-[50%]">
          ...
          <div className="flex flex-col lg:flex-row md:gap-4 xl:gap-16 justify-start lg:pr-8 xl:pr-16">
            <div className="space-y-2 flex flex-col">
              <Link
                href="/"
                className="text-gray-400 block md:inline transform hover:translate-x-2 hover:text-[#ff2e2b] transition duration-300"
              >
                Home
              </Link>
        ...
        {/* <div className="order-3 lg:order-2 pb-12 whitespace-nowrap lg:w-[30%]">
          ...
          <div className="space-y-2 flex flex-col lg:max-w-[80%]">
            ...
            <Link
              ...
              className="text-gray-400 transform hover:translate-x-2 hover:text-[#ff2e2b] transition duration-300 block md:inline"
            >
              How to earn money on Poppo Live
            </Link>
            <div className="h-px bg-[#242424]"></div>
            <Link
      ...
      <div className="border-t border-gray-800 pt-4 text-center lg:text-left lg:pl-[20%] order-4">
        <p className="text-sm text-gray-500">
          &copy; 2025 Let&apos;s Conect. All rights reserved.
        </p>
      </div>
    </footer>
  );
