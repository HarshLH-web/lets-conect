...
const Apply = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Apply Now | Let&apos;s Conect: Start Your Streaming Career
        </title>
        <meta
          name="description"
          content="Ready to take the next step? Unlock the world of opportunities in live-streaming and content creation. Apply to join Let's Conect today!"
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:url"
          content="https://www.letsconect.com/apply-now"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Apply Now | Let's Conect: Start Your Streaming Career"
        />
        ...
        <link rel="canonical" href="https://www.letsconect.com/apply-now" />
      </Head>

      <Header />
      <div className="apply-bg w-full h-52 lg:h-72 bg-[#DE0402] flex items-center justify-center">
        <h1 className="text-white text-4xl lg:text-6xl font-extrabold uppercase">
          Apply Now
        </h1>
      </div>
