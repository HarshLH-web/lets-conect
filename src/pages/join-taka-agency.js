  ...
  return (
    <>
      ...
      >
        <div className="flex lg:flex-row flex-col-reverse items-center justify-center gap-2 lg:gap-20 w-[90%] max-w-5xl mx-auto">
          ...
          <div>
            ...
            <ul className="list-decimal text-base lg:text-lg pl-4 space-y-2 text-black/80 mt-2 lg:mt-4">
              <li><a href="https://os8.me/CXcxwe" className="text-blue-700 underline">Download the TAKA Live app.</a></li>
        ...
        <a href="https://os8.me/rE8iKb" className="text-white bg-green-700 hover:bg-green-800 transition-colors duration-300 px-4 py-2 rounded-md mx-auto block w-fit mt-6">Join Agency</a>
      ...
      <section className="pb-12 pt-4 lg:pt-8 w-[90%] max-w-7xl mx-auto scroll-mt-12" id="invite-others">
        ...
        <a href="https://os8.me/rE8iKb" className="text-white bg-green-700 hover:bg-green-800 transition-colors duration-300 px-4 py-2 rounded-md mx-auto block w-fit mt-6">Join Taka Live Agency</a>
      </section>
      ...
      >
        ...
        <a href="https://os8.me/rE8iKb" className="text-white bg-green-700 hover:bg-green-800 transition-colors duration-300 px-4 py-2 rounded-md mx-auto block w-fit mt-6">Join Taka Agency</a>
