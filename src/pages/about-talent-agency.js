...
function About() {
  return (
    <>
      <Head>
        <title>
          About Let&apos;s Conect | Your Partner in Live Streaming Success
        </title>
        <meta
          name="description"
          content="Learn about Let's Conect, one of the top live-streaming agencies. Our mission is to create a community for talented content creators and hosts."
        />
        <meta
          name="keywords"
          content="Live Streaming, Talent Agency, Content Creator Agency"
        />
        {/* <!-- Facebook Meta Tags --> */}
        ...
        <meta
          property="og:title"
          content="Let's Conect | Your Partner in Live Streaming Success"
        />
        ...
        <link
          rel="canonical"
          href="https://www.letsconect.com/about-talent-agency"
        />
      </Head>
      <Header />
      <div>
        ...
        <h2 className="text-center text-4xl lg:text-5xl font-bold uppercase mt-10 lg:mt-20">
          we are <span className="text-[#DE0402]">talent agency</span>
        </h2>
        ...
        <div className="w-[90%] mx-auto lg:w-[80%] max-w-screen-xl flex flex-col lg:flex-row justify-center gap-2 lg:gap-12 mt-4 lg:mt-8 px-2 lg:px-0">
          <div className="flex-1">
            <p className="text-justify text-base lg:text-lg leading-normal text-[#727272]">
              Let&apos;s Conect bridges the gap between talented streamers and
              influencers with the leading live-streaming applications
              worldwide. We are passionate about empowering streamers and
              providing adequate support to help them thrive in the broadcasting
              industry. We reach a network of over 30,000 agents and 17,000
              hosts and work with individuals from regions including India,
              Pakistan, the Philippines, the USA, Africa, and Europe. We
              specialize in recruiting talented streamers and guiding them to
              achieve their dreams of becoming social stars or influencers. We
              welcome talent who brings energy, originality, and authenticity to
              their broadcasts.
            </p>
          </div>

          <div className="flex-1 flex flex-col gap-2 lg:gap-4 text-justify">
            <p className="text-base lg:text-lg leading-normal text-[#727272]">
              We collaborate with various live-streaming and video-calling
              applications like Poppo Live, Mimi, Chamet, Niki, HoneyCam, etc.
              We are proud to offer personalized support to each streamer and
              agent and contribute to their profitable live-streaming journey.
              We don&apos;t just see ourselves as a talent agency; we&apos;re a
              community of creators who support one another in achieving our
              goals.
            </p>
            <p className="text-base lg:text-xl font-semibold">
              At Let&apos;s Conect, the possibilities are endless. Whether you
              are an aspiring streamer or an experienced influencer, we invite
              you to be a part of an exciting journey.
            </p>
          </div>
        </div>
          ...
          <div className="flex-1 bg-black text-white text-center py-12 lg:py-20 rounded-[20px_20px_0px_0px] lg:rounded-[0px_35px_35px_0px]">
            <div className="w-[90%] lg:w-[80%] 2xl:px-20 mx-auto lg:ml-auto lg:pr-12 lg:mx-0">
              ...
              <p className="text-base lg:text-lg leading-normal">
                Our mission is to create a supportive community where every
                talent shines. We are dedicated to discovering and nurturing
                talents and ensuring every streamer has been given personalized
                support and opportunities to thrive in the live-streaming
                world.{" "}
              </p>
            </div>
          </div>
          <div className="flex-1 bg-[#DE0402] text-white text-center py-12 lg:py-20 rounded-[0px_0px_20px_20px] lg:rounded-[35px_0px_0px_35px]">
            <div className="w-[90%] lg:w-[85%] 2xl:px-20 mx-auto lg:mr-auto lg:pl-12 lg:mx-0">
              ...
              <p className="text-base lg:text-lg leading-normal">
                ...
                live-streaming becomes a colorful, vibrant community of
                creativity and connections. We aim to make live streaming a
                great space to share stories and passions, making each broadcast
                a celebration.
              </p>
            </div>
          </div>
        ...
        <div className="pb-12 lg:pb-12">
          <h2 className="text-center text-4xl lg:text-5xl font-bold uppercase mt-10 lg:mt-20">
            Our <span className="text-[#DE0402]">team</span>
          </h2>
            ...
            {OurTeam.map((item, index) => (
              ...
              >
                ...
                <div className="flex flex-col gap-0 py-3">
                  <p className="text-lg text-[#DE0402] font-semibold">
                    {item.name}
                  </p>
