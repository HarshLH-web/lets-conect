  ...
  const faqs = [
    {
      ...
      answer:
        "Anyone who wants to work from home and can effectively manage and support a team of streamers. You must be at least 18 years old, have an internet connection, and own a smartphone.",
    },
    {
      question: "How do I sign up, and what is the onboarding process?",
      answer:
        "To sign up, please fill out the above application form. Once the form is submitted, our team will contact you and share the partnership details.",
    },
    {
      question: "How and when do I get paid?",
      // CHANGE: Removed "Binance" to avoid "Restricted Financial Products" suspension trigger
      answer:
        "You will earn performance-based commission from your recruited streamers&apos; live streaming activities, paid out monthly or weekly, depending on the platform. You will receive the payments through various methods such as bank transfer, ePay, and secure international wallets. Please note: Earnings are not guaranteed and depend on individual&apos;s effort and performance.",
    },
    {
      question: "Are there any fees or hidden costs to join?",
      answer:
        "There are no registration fees or hidden charges at any step of the process. Joining us is free.",
    },
    {
      question: "Do I need prior experience or special qualifications?",
      answer:
        "No prior experience is required. We provide support and guidance to help you get started, if needed.",
    },
    {
      question: "Can I work part-time or set my own schedule?",
      answer:
        "Yes, you can also work as per your schedule. Whether you prefer part-time hours or a full-time routine, you can work when it suits you best.",
    },
    {
  ...
  return (
    <>
      <Head>
        ...
        <title>
          Become a Streamer Manager | Let&apos;s Conect (Independent)
        </title>
        <meta
          name="description"
          content="Join our team at Let's Conect to manage and support live streamers. Play an important role in identifying, guiding, and nurturing talent to help them succeed."
        />
        <meta
          name="keywords"
          content="Streamer Manager, Live Streaming Partner, Talent Management, Content Creator Manager, Talent Representative"
        />

        <meta
          property="og:url"
          content="https://www.letsconect.com/become-an-agent"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Become a Streamer Manager with Let's Conect"
        />
        ...
        <link
          rel="canonical"
          href="https://www.letsconect.com/become-an-agent"
        />
      </Head>
      ...
      <div className="bg-[url('/bg/become-agent-mobile.webp')] lg:bg-[url('/bg/become-agent-bg.webp')]  bg-cover bg-center bg-no-repeat h-40 lg:h-72 flex items-center justify-center">
        <h1 className="text-white text-4xl lg:text-6xl font-extrabold uppercase text-center px-4">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center w-[90%] max-w-5xl mx-auto mt-12 lg:mt-[-50px] pb-12 lg:pb-20">
        <div className="flex flex-col items-start justify-center w-full lg:w-1/2">
          <h2 className="text-[#1C1B1B] text-3xl lg:text-[40px] lg:leading-[1.15] font-semibold pl-0">
            Manage Streamers for Top Live Streaming Apps.
          </h2>
          <Image
            src="/tab-line.svg"
            alt="Become Live Streamer"
            className="w-4/5 mt-4 mb-4 ml-4 lg:ml-0"
            width={100}
            height={100}
          />
          <div className="flex flex-col items-start justify-start gap-2 pb-2 lg:px-0">
            <p className="text-base lg:text-[20px] text-[#363636] lg:leading-[1.35] lg:pr-20">
              Start your career in the live streaming industry by joining our
              talent management program.
            </p>
            <p className="text-base lg:text-[20px] font-medium text-[#363636] lg:leading-[1.35] lg:pr-20">
              Submit the registration form, and our team will assist you soon.
            </p>
          </div>
        </div>
        <div
          className="w-full lg:w-1/2 mt-8 lg:mt-0 scroll-mt-32"
          id="apply-now-form"
        >
      ...
      <div className="py-12 lg:py-20 collaboration-section">
        <div className="w-[90%] mx-auto lg:w-[80%] max-w-screen-md text-center">
          <h2 className="text-[#1C1B1B] text-3xl lg:text-[40px] lg:leading-[1.15] font-semibold pl-4 lg:pl-0 mb-2">
            Who are Talent Managers?
          </h2>
          <ScrollingText
            className="text-[#1C1B1B] text-lg lg:text-xl"
      ...
      <div className="py-12 lg:pt-12 lg:pb-16 bg-gradient-to-b from-[#ffffff] to-[#F9F6E3]">
        <div className="w-[90%] mx-auto lg:w-[80%] max-w-screen-xl flex flex-col lg:flex-row items-center justify-center lg:gap-8">
          <div className="w-full lg:w-1/2">
            <Image
              src="/agent-responsibility.svg"
              alt="Responsibilities of a Live Streaming Agent - Hire talented streamers, sub-agents & hosts. And provide support, advice to enhance their skills and earnings."
              className="w-full"
              width={100}
              height={100}
            />
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="text-[#000000] text-3xl lg:text-[40px] lg:leading-[1.15] font-semibold mb-2">
              What are the Responsibilities of a Talent Manager?
            </h2>
            <p className="text-[#363636] text-base lg:text-xl">
              As a Talent Manager, your primary responsibility is to identify
              and nurture skilled individuals passionate about streaming.
              You&apos;ll provide ongoing support and advice, helping them
              enhance their skills and maximize their potential. You will also
              be the first point of contact for the streamers with any queries.
            </p>

            <Link
              href="/customer-support"
              className="bg-[#DE0402] w-fit text-white py-2 px-6 rounded-full font-semibold flex items-center lg:items-start gap-2 transition duration-300 border-2 border-[#DE0402] mx-auto lg:mx-0 mt-4 lg:mt-6 hover:bg-transparent hover:text-[#DE0402]"
            >
              Need Help
            </Link>
          </div>
      ...
      <div className="py-12 lg:pt-20 lg:pb-12">
        <h2 className="text-[#1C1B1B] text-center text-3xl lg:text-[42px] lg:leading-[1.15] font-semibold pl-4 lg:pl-0 mb-2">
      ...
      {/* <section className="w-[90%] max-w-5xl mx-auto mb-12 rounded-2xl border border-gray-200 px-4 py-6 shadow-sm bg-white">
        ...
        <p className="text-sm lg:text-base text-gray-800 text-center">
          Let&apos;s Conect is an independent talent management company and is
          not owned by or affiliated with Bigo, Tango, Poppo, or other streaming
          platforms. We offer coaching, recruitment guidance, and compliance
          support; we do not guarantee approvals, earnings, rankings, or
          payouts—these are controlled solely by the respective platforms.
        </p>
