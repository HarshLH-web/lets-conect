...
function Support() {
  ...
  return (
    <>
      <Head>
        <title>Customer Support | Let&apos;s Conect: We are here to Help</title>
        <meta
          name="description"
          content="Need assistance? Contact Let's Conect's customer support for all your live streaming and hosting inquiries. Fill out this form and reach us anytime."
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:url"
          content="https://www.letsconect.com/customer-support"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Customer Support | Let's Conect: We are here to Help"
        />
        ...
        <link
          rel="canonical"
          href="https://www.letsconect.com/customer-support"
        />
      </Head>
      <Header />
      <div className="contact-bg">
        <h1 className="text-white text-4xl lg:text-6xl font-bold uppercase text-center px-8">
          Customer Support
        </h1>
      </div>
