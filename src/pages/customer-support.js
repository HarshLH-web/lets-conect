  ...
  return (
    ...
    <div className='contact-bg'>
      ...
      <div className='w-[100%] mx-auto max-w-3xl flex flex-col items-center justify-center mt-10 pb-12'>
        ...
        <a href='https://api.whatsapp.com/send/?phone=9650889239&text&type=phone_number&app_absent=0' className='text-base bg-[#FFF5F4] my-2 w-[90%] max-w-sm border-[1px] border-[#DE0402] rounded-full whitespace-nowrap py-3 text-center mt-6'><span className='font-bold'>WhatsApp:</span> +919650889239</a>
