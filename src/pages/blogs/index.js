  ...
  itemListElement: [
    {
      ...
      position: 1,
      name: "Home",
      item: "https://www.letsconect.com/",
    },
    {
      "@type": "ListItem",
      position: 2,
      name: "Blogs",
      item: "https://www.letsconect.com/blogs",
    },
  ],
};
...
function Blogs() {
  ...
  return (
    <>
      <Head>
        <title>Let&apos;s Conect Blog: Tips for Streamers</title>
        <meta
          name="description"
          content="Let's Conect's blog page provides you with all the needed information with updated details, insights, and tips about the live streaming industry. Explore Now!"
        />
        <meta
          name="keywords"
        ...
        />
        {/* <!-- Facebook Meta Tags --> */}
        <meta property="og:url" content="https://www.letsconect.com/blogs" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Let's Conect Blog: Tips for Streamers"
        />
        ...
        <meta
          ...
          content="https://www.letsconect.com/blogs"
        />
        <meta
          name="twitter:title"
          content="Let's Conect Blog: Tips for Streamers"
        ...
        <link rel="canonical" href="https://www.letsconect.com/blogs" />
            ...
            <div key={blog._id} className="rounded-lg overflow-hidden">
              ...
              >
                ...
                >
                  ...
                  <button className="bg-white hover:bg-[#DE0402] text-[#DE0402] hover:text-white border-[2px] transition-all duration-300 border-[#DE0402] px-4 py- rounded-full mt-3">
                    Read More
                  </button>
                </div>
              </Link>
