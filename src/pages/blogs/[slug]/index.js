...
function BlogDetailPage({ blog }) {
  ...
  return (
    <>
      <Head>
        <title>{`${blog.metaTitle} | Let&apos;s Conect`}</title>
        <meta name="description" content={blog.metaDescription} />
        <link rel="canonical" href={`${blog.canonicalUrl}`} />
        <meta name="keywords" content={blog.metaKeywords?.join(", ") || ""} />
        <meta
          property="og:url"
          content={`https://www.letsconect.com/blogs/${blog.slug}`}
        />
      ...
      <div
        id="blog-container"
        className="w-[95%] lg:w-[90%] max-w-7xl mx-auto pb-48 pt-4 lg:pt-16 lg:pb-44 bg-gray-50 border-x-[1px] border-gray-200 mb-[-130px]"
      >
        <div
          ...
          style={{
            ...
            backgroundImage: `url(${isMobile ? blog.mobileBannerImage : blog.desktopBannerImage})`,
          }}
        >
          <h1
            className="text-3xl font-bold max-w-[44rem] mx-auto text-white text-center px-2"
