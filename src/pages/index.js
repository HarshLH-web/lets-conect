...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>
          Let&apos;s Conect | Connecting Talent with Top Streaming Opportunities
        </title>
        <meta
          name="description"
          content="Discover Let's Conect, a leading live-streaming talent agency, connects talented streamers with top streaming opportunities. Join us today!"
        />
        <meta
          name="keywords"
          content="Let's Conect, Live Streaming Agency, Live Streaming Talent Agency"
        />

        {/* <!-- Facebook Meta Tags --> */}
        <meta property="og:url" content="https://www.letsconect.com" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Let's Conect | Connecting Talent with Top Streaming Opportunities"
        />
        ...
        <meta property="twitter:url" content="https://www.letsconect.com" />
        <meta
          name="twitter:title"
          content="Let's Conect | Connecting Talent with Top Streaming Opportunities"
        />
        ...
        <meta
          ...
          content="a77a4c2cd1da692ab97cb76168926953"
        />

        <link rel="canonical" href="https://www.letsconect.com/" />
        ...
        <div className="flex flex-col lg:flex-row w-[90%] xl:w-[80%] pb-8 mx-auto h-full pt-28 lg:pt-40 lg:pb-0">
          ...
          <div className="w-full lg:w-3/5 flex flex-col justify-center text-center lg:text-left 2xl:pl-12 gap-4 mb-8">
            <h1 className="text-[35px] max-w-[300px] mx-auto sm:mx-0 sm:max-w-none sm:text-[3rem] xl:text-6xl 2xl:text-[4.25rem] leading-[1.15] sm:leading-tight uppercase font-black">
              Let&apos;s Conect <span className="sm:hidden">where</span> <br />
              <span className="inline-flex items-center gap-4">
                <span className="hidden sm:block">where</span> talent
                <span>
                  <Image
                    src="/live-hosting.gif"
                    alt="Live Icon"
                    priority={true}
                    className="w-auto h-12 sm:h-16 xl:h-20 2xl:h-24 object-contain sm:mt-1"
                    width="50"
                    height="24"
                  />
                </span>
            ...
            <div className="flex flex-col gap-2">
              <p className="text-base lg:text-lg lg:pr-24 lg:leading-normal">
                With a network of over 30,000+ agents and 17,000+ hosts
                worldwide—from India to the USA, Africa, and beyond. We
                specialize in connecting top talent to live-streaming and
                video-calling apps. With our personalized guidance and
                expertise, make your live-streaming a winning journey.
              </p>
              <p className="text-base lg:text-xl lg:pr-24 font-semibold mt-2">
                Ready to take your streaming journey to the next level? Let us
                help you shine on the world&apos;s leading platforms.
              </p>
            </div>
          ...
          <div className="w-full lg:w-2/5 flex items-end">
            <Image
              src="/men-2.png"
              alt="Let's Conect - live streaming - Become a streamer"
              className="hidden lg:block mx-auto lg:m-0 w-64 lg:w-[100%] xl:w-[100%] 2xl:w-auto"
              loading="lazy"
              width="1000"
              height="256"
            />
      ...
      <section>
        <div className="w-[90%] mx-auto bg-white pt-12 pb-20 lg:pt-24 lg:pb-32 ">
          <h2 className="uppercase text-center text-black font-extrabold text-4xl md:text-5xl leading-tight md:leading-snug">
            Our Services
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 md:gap-4 mx-auto mt-8 2xl:mt-16 max-w-7xl">
            {/* Box 1 */}
            <div className="box1 max-w-[400px] mx-auto">
              {" "}
              {/* Box Content  */}
              <div className="mt-56 px-8 text-center">
                ...
                <p className="mt-2">
                  We discover and nurture extraordinary individuals with a
                  passion for entertainment. Whether it&apos;s singing, dancing,
                  comedy, or simply connecting with audiences, we give every
                  talent a platform to shine and follow their dreams of becoming
                  social stars.
                </p>
              </div>
            </div>
            ...
            {/* Box 2 */}
            <div className="box2 max-w-[400px] mx-auto">
              {" "}
              {/* Box Content  */}
              <div className="mt-56 px-8 text-center">
                ...
                <p className="mt-2">
                  Behind every successful streamer, there is a dedicated agent.
                  With countless streamers joining the industry, skilled agents
                  are essential to guide them. We recruit agents with basic
                  managerial skills who can mentor their streamers to thrive in
                  the industry.
                </p>
              </div>
            </div>
            ...
            {/* Box 3 */}
            <div className="box3 max-w-[400px] mx-auto">
              {" "}
              {/* Box Content  */}
              <div className="mt-56 px-8 text-center">
                ...
                <p className="text-base mt-2">
                  Managing talent is more than recruiting—it&apos;s about
                  building careers. Our team focuses on providing personalized
                  support, expert guidance, and growth strategies to help
                  individuals build profitable careers and achieve their dreams.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <Link
              href="/our-services"
              className="hover:bg-transparent hover:text-[#DE0402] bg-[#DE0402] border-[#DE0402] border-2 text-white font-medium rounded-full mt-10 lg:mt-12 mx-auto block transition duration-300 px-4 py-2"
      ...
      <section id="wwa">
        <div className="w-[90%] mx-auto pt-12 lg:pt-24 lg:pb-16">
          <h2 className="uppercase text-center text-white font-extrabold text-4xl lg:text-6xl 2xl:text-7xl">
            {" "}
            What <span className="text-[#DE0500]">we</span> achieved
          </h2>
          <div className="flex flex-col lg:flex-row max-w-5xl lg:gap-8 mx-auto mt-8 lg:mt-0">
            <div className="w-full lg:w-1/2 text-white flex items-center mx-auto px-6 lg:px-12 py-6 lg:py-4 wwa-gradient lg:my-8 mb-4 text-lg text-center lg:text-left">
              <p className="text-base lg:text-lg leading-snug">
                Our journey began with a vision, and today, we are the top
                recruiter for most of our collaborated apps. Every milestone
                reflects our dedication to reaching new heights, from recruiting
                new talent to shaping careers.
              </p>
            </div>
            <InView>
              {({ ref, inView }) => (
                <div
                  ref={ref}
                  className="w-full lg:w-1/2 my-4 flex items-center justify-center"
                >
                  <div ref={ref}>
                    {inView && (
                      <Lottie animationData={groupAnimation} loop={false} />
                    )}
                  </div>
                </div>
              )}
          ...
          <div className="flex flex-col lg:flex-row max-w-6xl mx-auto pt-8 pb-16 lg:py-4 lg:mt-4">
            <div className="w-full lg:w-[35%] flex flex-col items-center justify-center gap-2 lg:gap-4">
              ...
              <h3 className="text-4xl lg:text-5xl font-semibold text-[#DE0402] uppercase">
                Host
              </h3>
      ...
      <section className="bg-[#FFE9DF] py-12 lg:py-24">
        <div className="max-w-7xl mx-auto  w-[90%]">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-2">
            <h2 className="uppercase text-center text-black font-extrabold text-4xl lg:text-6xl 2xl:text-7xl leading-snug">
              Our Apps
            </h2>
            <p className="text-base font-medium max-w-[36rem] text-center lg:text-left ">
              Explore our top collaborations with live streaming applications,
      ...
      <section className="collaboration-section">
        <div className="mx-auto w-[90%] max-w-6xl text-black py-12 md:py-24 text-center flex flex-col items-center justify-center gap-4">
          <h2 className="text-[30px] sm:text-[3rem] lg:text-7xl font-bold leading-[1.15] sm:leading-tight capitalize">
            ...
            <span className="inline-flex flex-col lg:flex-row items-center justify-center">
              Through
          ...
          <p className="text-base lg:text-3xl max-w-2xl mx-auto font-semibold">
            Interested in collaborating? Let&apos;s make magic happen!
          </p>
